      ...
      <div className='flex justify-between'>
        ...
        <Link href="/">
          <div className='flex flex-col items-center gap-[2px]'>
            <Image src={pathname === '/' ? "/firered.svg" : "/fire.svg"} className='w-[40px] h-[40px]' alt="Icon"/>
        ...
        <Link href="/page2">
          <div className='flex flex-col items-center gap-[2px]'>
            <Image src={pathname === '/page2' ? "/trainingred.svg" : "/training.svg"} className='w-[40px] h-[40px]' alt="Icon"/>
        ...
        <Link href="/page3">
          <div className='flex flex-col items-center gap-[2px]'>
            <Image src={pathname === '/page3' ? "/foodred.svg" : "/food.svg"} className='w-[40px] h-[40px]'alt="Icon" />
        ...
        <Link href="/page4">
          <div className='flex flex-col items-center gap-[2px]'>
            <Image src={pathname === '/page4' ? "/progressred.svg" : "/progress.svg"} className='w-[40px] h-[40px]' alt="Icon" />
